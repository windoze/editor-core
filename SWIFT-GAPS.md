...
- 继续扩展 fixtures，覆盖 WorkspaceEdit/failure 等更多 popup 类型、Code Lens/Inlay/Document Links/Colors/Hierarchy 等更多持久在线 result panels，以及经审核的跨 theme/window-size 真实 baseline 场景。
