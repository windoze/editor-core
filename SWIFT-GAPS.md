...
- 继续扩展 fixtures，覆盖更多 WorkspaceEdit rollback secondary failure/edge-case 变体、专门的 global undo history UI 形态和更多 failure 边界变体，以及经审核的跨 theme/window-size 真实 baseline 场景。
