...
- 已有 last macro 录制/回放和 `.sublime-macro` 兼容持久化起点，但还没有命名/多宏管理、导入导出 UI、完整 Sublime `.sublime-macro` 运行语义或 plugin/package command runtime。
- 没有 build systems。
