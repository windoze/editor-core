...
enum AttoAccessibilityID {
    ...
    static let findInFilesReplacementField = "AttoEditor.FindInFiles.ReplacementField"
    static let findInFilesReplaceAllButton = "AttoEditor.FindInFiles.ReplaceAll"
    static let findInFilesCaseSensitiveButton = "AttoEditor.FindInFiles.CaseSensitive"
    static let findInFilesWholeWordButton = "AttoEditor.FindInFiles.WholeWord"
    static let findInFilesRegexButton = "AttoEditor.FindInFiles.Regex"
    ...
    static let problemsPanelMetadataLabel = "AttoEditor.LSP.ProblemsPanel.Metadata"
    ...
    static let workspaceProblemsPanelMetadataLabel = "AttoEditor.LSP.WorkspaceProblemsPanel.Metadata"
    ...
    static let lspWorkbenchHistoryPanelMetadataLabel = "AttoEditor.LSP.WorkbenchHistory.Metadata"
    static let lspWorkbenchHistoryPanelTable = "AttoEditor.LSP.WorkbenchHistory.Table"
    static let lspWorkbenchHistoryPanelScrollView = "AttoEditor.LSP.WorkbenchHistory.ScrollView"
    static let lspWorkbenchHistoryPanelRow = "AttoEditor.LSP.WorkbenchHistory.Row"
    static let lspWorkbenchHistoryPanelRowTitle = "AttoEditor.LSP.WorkbenchHistory.RowTitle"
    static let lspWorkbenchHistoryPanelRowDetail = "AttoEditor.LSP.WorkbenchHistory.RowDetail"
    static let lspWorkbenchHistoryPanelRowStatus = "AttoEditor.LSP.WorkbenchHistory.RowStatus"
    ...
    static let workspaceEditHistoryPanelOpenConflictButton = "AttoEditor.WorkspaceEditHistory.OpenConflict"
    static let workspaceEditHistoryPanelSaveConflictButton = "AttoEditor.WorkspaceEditHistory.SaveConflict"
    static let workspaceEditHistoryPanelDiscardConflictButton = "AttoEditor.WorkspaceEditHistory.DiscardConflict"
    static let workspaceEditHistoryPanelSaveAndReapplyButton = "AttoEditor.WorkspaceEditHistory.SaveAndReapply"
    static let workspaceEditHistoryPanelDiscardAndReapplyButton = "AttoEditor.WorkspaceEditHistory.DiscardAndReapply"
    static let workspaceEditHistoryPanelRerunRequestButton = "AttoEditor.WorkspaceEditHistory.RerunRequest"
    static let workspaceEditHistoryPanelReapplyButton = "AttoEditor.WorkspaceEditHistory.Reapply"
    static let workspaceEditHistoryPanelUndoButton = "AttoEditor.WorkspaceEditHistory.UndoLatest"

    static let settingsValidationPanel = "AttoEditor.Settings.ValidationPanel.Panel"
    static let settingsValidationPanelRoot = "AttoEditor.Settings.ValidationPanel.Root"
    static let settingsValidationPanelSearchField = "AttoEditor.Settings.ValidationPanel.SearchField"
    static let settingsValidationPanelMetadataLabel = "AttoEditor.Settings.ValidationPanel.Metadata"
    static let settingsValidationPanelTable = "AttoEditor.Settings.ValidationPanel.Table"
    static let settingsValidationPanelScrollView = "AttoEditor.Settings.ValidationPanel.ScrollView"
    static let settingsValidationPanelRow = "AttoEditor.Settings.ValidationPanel.Row"
    static let settingsValidationPanelRowTitle = "AttoEditor.Settings.ValidationPanel.RowTitle"
    static let settingsValidationPanelRowDetail = "AttoEditor.Settings.ValidationPanel.RowDetail"
    static let settingsValidationPanelRowStatus = "AttoEditor.Settings.ValidationPanel.RowStatus"
