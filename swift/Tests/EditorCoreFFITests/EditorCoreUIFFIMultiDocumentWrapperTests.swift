...
extension EditorCoreUIFFITests {
    func testMultiDocumentEditorUIWrapperExposesTabsSplitsPreviewAndSearch() throws {
        ...
        XCTAssertEqual(lspServers[0].sessionPolicy, EcuProjectLspSessionPolicy())
        ...
        XCTAssertEqual(lspServers[1].sessionPolicy, EcuProjectLspSessionPolicy(sharedSession: false))
        ...
        XCTAssertEqual(startPlan[0].attemptId, 1)
        ...
        XCTAssertEqual(startPlan[0].sessionKey, "workspace:rust:file:///new|file:///other")
        XCTAssertEqual(startPlan[0].sessionPolicy, lspServers[0].sessionPolicy)
        ...
        XCTAssertEqual(stopPlan.map(\.attemptId), [1, 2])
        ...
        XCTAssertEqual(stopPlan[0].sessionKey, "workspace:rust:file:///new|file:///other")
        XCTAssertEqual(stopPlan[0].sessionPolicy, lspServers[0].sessionPolicy)
        ...
        XCTAssertEqual(stopPlan[1].sessionKey, "document:swift:file:///project/Beta.swift")
        XCTAssertEqual(stopPlan[1].sessionPolicy, lspServers[1].sessionPolicy)
        ...
        XCTAssertEqual(restartPlan.map(\.attemptId), [1, 2])
        ...
        XCTAssertEqual(restartPlan[0].sessionKey, "workspace:rust:file:///new|file:///other")
        XCTAssertEqual(restartPlan[0].sessionPolicy, lspServers[0].sessionPolicy)
        ...
        XCTAssertEqual(restartPlan[1].sessionKey, "document:swift:file:///project/Beta.swift")
        XCTAssertEqual(restartPlan[1].sessionPolicy, lspServers[1].sessionPolicy)
        ...
        XCTAssertEqual(lifecycleEvents.events[0].sessionKey, "document:rust:file:///project/main.rs")
        XCTAssertEqual(lifecycleEvents.events[0].sessionPolicy, EcuProjectLspSessionPolicy(sharedSession: false))
