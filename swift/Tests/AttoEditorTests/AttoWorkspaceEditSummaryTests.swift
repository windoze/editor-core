...
final class AttoWorkspaceEditSummaryTests: XCTestCase {
    ...
    func testWorkspaceEditPreviewListsTypedConflicts() throws {
        ...
        XCTAssertEqual(preview.firstSaveableConflictTargetURI, "file:///project/dirty.swift")
        XCTAssertEqual(preview.firstDiscardableConflictTargetURI, "file:///project/dirty.swift")
        XCTAssertEqual(preview.conflictTargetURI(for: sections[1]), "file:///project/dirty.swift")
        XCTAssertEqual(preview.saveableConflictTargetURI(for: sections[1]), "file:///project/dirty.swift")
        XCTAssertEqual(preview.discardableConflictTargetURI(for: sections[1]), "file:///project/dirty.swift")
