...
final class AttoEditorPreferencesApplicationTests: XCTestCase {
    ...
    private func openEditor(wrapMode: EcuWrapMode) throws -> EditorCoreSkiaView {
        ...
        let prefs = makeIsolatedPreferences(wrapMode: wrapMode)
    ...
    private func makeIsolatedPreferences(wrapMode: EcuWrapMode) -> AttoPreferences {
