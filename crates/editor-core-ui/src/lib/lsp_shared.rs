...
impl LspResultSlot {
    pub(crate) fn from_response_method(method: &str) -> Option<Self> {
        match method {
            ...
            "textDocument/inlayHint" => Some(Self::InlayHints),
            "textDocument/documentLink" => Some(Self::DocumentLinks),
    ...
    pub(crate) fn method(self) -> &'static str {
        match self {
            ...
            Self::DocumentLinks => "textDocument/documentLink",
            Self::SemanticTokensFull => "textDocument/semanticTokens/full",
            Self::SemanticTokensDelta => "textDocument/semanticTokens/full/delta",
    ...
    pub(crate) fn slot_name(self) -> &'static str {
        match self {
            ...
            Self::SemanticTokensDelta => "semantic_tokens_delta",
    ...
    pub(crate) fn family(self) -> &'static str {
        match self {
            ...
            Self::InlayHints => "inlay_hints",
            Self::DocumentLinks => "document_links",
            Self::SemanticTokensFull | Self::SemanticTokensDelta | Self::SemanticTokensRange => {
                "semantic_tokens"
            }
    ...
    pub(crate) fn title(self) -> &'static str {
        match self {
            ...
            Self::InlayHints => "LSP Inlay Hints",
            Self::DocumentLinks => "LSP Document Links",
            Self::SemanticTokensFull => "LSP Semantic Tokens Full",
            Self::SemanticTokensDelta => "LSP Semantic Tokens Delta",
            Self::SemanticTokensRange => "LSP Semantic Tokens Range",
