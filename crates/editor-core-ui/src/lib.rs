...
pub use multi_document::{
    ...
    ProjectLspStopPlanEntry, ProjectLspWorkspaceFolder, RecentFileEntry, RecentProjectEntry, TabId,
    TabSearchResult, WorkspaceDiagnostic, WorkspaceDiagnosticDocumentReport,
    ...
    WorkspaceDiagnosticsStore, WorkspaceEditTransactionConflict, WorkspaceEditTransactionDocument,
